...
- `peerhub-dctx-trust-anchor-proposal-cc-2026-09-14.md` — PROPOSAL: answers Q2/D2 (admission-transaction-scoped credential table, keyed to R2's opaque workspace_home_id/activation_epoch; explicitly claims confusion-detection only, not compromised-worker resistance). Awaiting independent review before D1 may begin.
