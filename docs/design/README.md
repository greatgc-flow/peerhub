...
- `peerhub-holistic-renewal-RATIFIED-cx-astra-2026-09-13.md` — Current superseding renewal direction for the whole PeerHub product/architecture (R0–R5, D0/D1 work-package ordering); D1's Increment 1 (see above) is closed; Increment 2 (high-risk enforcement) and Increment 3 (full governance convergence) remain future staged work, not yet implemented.
