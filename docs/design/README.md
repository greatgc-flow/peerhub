...
- `peerhub-holistic-renewal-RATIFIED-cx-astra-2026-09-13.md` — Current superseding renewal direction for the whole PeerHub product/architecture (R0–R5, D0/D1 work-package ordering); R0/R2/R3/R5 and D0/D1's Increment 1 (see above) are all shipped; only R4 (P4b governance convergence + typed call, depends on D1) and D1's own Increment 2/3 remain future staged work, not yet started.
