...
CREATE TABLE shim_pending_operations (
    ...
    CHECK (
        (
            ...
            AND TRIM(force_override_reason) != ''
            AND intended_fallback_tool_path IS NULL
        ) OR (
