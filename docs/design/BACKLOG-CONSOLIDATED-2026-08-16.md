...
- ~~EvidenceArtifact / 3-Tier Context Partitioning~~ - **INCREMENT 1 DONE 2026-08-16 (`baa6a04`)**: `EvidenceArtifact` dataclass + migration `0023_evidence_artifacts.sql` (data layer only). Increment 2 (adapter wiring: the actual offload/substitution mechanism, design Sections 2-3) not yet started.
