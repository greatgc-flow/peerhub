...
- **SL-04/05/06**: expanded to match `SL-01-06-SESSION-LEASE-CLASSIFICATION-SPEC-R1.md`'s
  ...
  running the suite. 262/262 tests green. `docs/history/design/phase0/fixtures/
...
`docs/history/design/phase0/fixtures/source-evidence-manifest-v1.json` now binds
...
`docs/history/design/phase0/fixtures/captures/`, which holds only flat, immutable
