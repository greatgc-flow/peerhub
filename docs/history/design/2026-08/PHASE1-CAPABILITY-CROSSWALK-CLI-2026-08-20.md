...
- **Current Real Consumers (Empirically Measured):** _sys/core/hub.py, _sys/checks/canary_budget.py, _sys/tests/unit/test_peer_mgr_c10.py
  ...
  - Real Grep Evidence (149 external matches, 0 self matches):
    ...
    P:/workspace/peerhub/docs/history/design/phase0/shared-seam-ledger.json:351:    "_write_json_atomic": {
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:1566:          "_write_json_atomic",
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:1645:          "_write_json_atomic",
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:1727:          "_write_json_atomic",
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:1800:          "_write_json_atomic",
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:1855:          "_write_json_atomic"
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:1945:          "_write_json_atomic",
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:2074:          "_write_json_atomic",
    P:/workspace/peerhub/docs/history/design/phase0/legacy-hub-surface-old.json:2326:          "_write_json_atomic",
