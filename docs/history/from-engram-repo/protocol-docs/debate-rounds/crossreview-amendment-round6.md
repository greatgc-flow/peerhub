...
[CONSENSUS_REVOKE: crossreview-amendment-20260613-v5 | reason: §14 cross-review CR-11, CR-12]
Cross-review counter RESET — v6 proposal lineage begins.

---

[PROPOSAL: crossreview-amendment-20260613-v6]
Content:

## Proposed Amendment to DEBATE_PROTOCOL v0.5 — v6

### Summary of changes from v5

| # | Change | Source |
|:-:|:-------|:-------|
| 1–22 | All v5 changes retained | (see round5) |
| 23 | §14-2: SUMMARY_DISPUTE fix — original peer revises own summary; coordinator distributes only | CR-11 (gc) |
| 24 | §14-5: LOW action fallback — refusal must trigger SEVERITY_CHALLENGE first; if confirmed LOW but still refused → H-2 | CR-12 (gc) |

---

### §14 Exhaustive Cross-Review Phase (끝장 교차검토) — v6 full text
...
finding. H-2 may: accept the risk on behalf of the team, direct the peer to accept or
challenge again, split to SUB_ISSUE, or ABORT(A-2).
...
### Changes 2–9 (unchanged from v5/v4/v3)

All other changes (§6 update, §8 diagram, §8 note, §15 DEFERRED, Appendix A, B-13, C, D)
are identical to v5. Only §14 section text is modified in this version.

---

Version-Tag: v6
Issued By: cc
Issued At: 2026-06-13T11:00:00Z
Status: UNDER_REVIEW
