...
## Proposed Amendment to DEBATE_PROTOCOL v0.5 — v3

### Summary of changes from v2

| # | Change | Source |
|:-:|:-------|:-------|
| 1–13 | All v2 changes retained | (see round2) |
| 14 | `BOTH_MISSED` → `MISSED_BY_ALL` everywhere | gc |
| 15 | §14-5 challenge: remove "unanimous vote"; define all vote outcomes | cx + gc |
| 16 | Appendix A Step 6-B: clarify LOW exception to "Repeat until all CLEAN" | cx |

---

### §14 Exhaustive Cross-Review Phase (끝장 교차검토) — v3 full text
...
- 2/3 or more vote HIGH → CRITICAL/HIGH applies.
- All peers vote LOW (unanimous LOW) → LOW applies.
- Any other result (e.g., 1 HIGH, 2 LOW in a 3-peer debate) → defaults to HIGH (fail-safe).
...
### Change 2: §6 update (unchanged from v2)
...
### Change 3: §8 diagram (unchanged from v2)
...
### Change 4: §8 SEE/VERIFY note (unchanged from v2)
...
### Change 5: §15 (renumbered from §14 DEFERRED — unchanged from v2)

Existing §14 DEFERRED content moved to §15, unchanged.

---

### Change 6: Appendix A update — v3
...
### Change 7: Appendix B-13 update — v3
...
### Change 8: Appendix C anti-patterns — v3 (unchanged from v2)
...
### Change 9: Appendix D template — §14 section — v3
...
Version-Tag: v3
Issued By: cc
Issued At: 2026-06-13T08:30:00Z
Status: UNDER_REVIEW
