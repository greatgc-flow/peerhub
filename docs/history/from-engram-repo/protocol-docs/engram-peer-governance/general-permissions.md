> **Recovered 2026-09-08** from P:\_sys\docs-v2\general\permissions.md during the pre-wipe P: audit. Never made it into this history folder during the 2026-09-04 docs-v2 disposition. The per-peer invocation-flags table here (--dangerously-skip-permissions etc.) is superseded by peerhub's real, code-enforced CapabilityTier system (READ_ONLY/WORKTREE_WRITE/GIT_MUTATE) -- kept as historical design rationale, not current instruction.
