> **Recovered 2026-09-08** from P:\_sys\docs-v2\ops\capability-leveling.md during the pre-wipe P: audit. Never made it into this history folder during the 2026-09-04 docs-v2 disposition (capability-leveling-decisions.md and capability-leveling-framework-2026-07-13.md were captured; this base framework doc was missed). This is the original design-rationale document for the capability-scoring vector concept peerhub's real, shipped peerhub/routing/capability_matching.py later implemented -- kept as historical provenance, not current spec.
