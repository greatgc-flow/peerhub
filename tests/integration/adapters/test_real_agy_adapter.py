...
@pytest.mark.slow
def test_real_agy_adapter_shells_out():
    """Integration test that shells out to real agy.exe (not mocked)."""
    ...
    assert plan.argv == ("agy.exe", "-p", "say hello in two words", "--output-format", "json")
